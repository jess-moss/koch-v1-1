...
<a name="myfootnote14">14</a>: The observant technician may realize the Serial Bus Servo Driver Board suggests an input DC voltage between 9 - 12.6V, where for the leader arm we are only applying 5V. This will not hurt the board, and must be done to correctly power the servos on the leader arm.